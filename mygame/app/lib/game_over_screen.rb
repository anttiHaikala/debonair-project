class GameOverScreen
  ...
  def self.tick args
    ...
    if args.state.hero.has_item?(:amulet_of_skandor) && !args.state.hero.perished
      args.outputs.labels << { x: 640, y: 520, text: "Congratulations!", size_enum: 5, alignment_enum: 1, r: 250, g: 250, b: 250 }
      args.outputs.labels << { x: 640, y: 470, text: "You have retrieved the Amulet of Skandor", size_enum: 3, alignment_enum: 1, r: 250, g: 250, b: 250 }
      args.outputs.labels << { x: 640, y: 440, text: "and escaped the dungeon alive!", size_enum: 3, alignment_enum: 1, r: 250, g: 250, b: 250 }
      args.outputs.labels << { x: 640, y: 380, text: "SCORE: #{args.state.final_score}", size_enum: 3, alignment_enum: 1, r: 250, g: 250, b: 250 }
      ...
      if args.state.hero.perished
        ...
        args.outputs.labels << { x: 640, y: 460, text: "You have died #{reason_of_death} on level #{args.state.current_depth + 1}.".gsub('  ', ' '), size_enum: 3, alignment_enum: 1, r: 250, g: 250, b: 250 }
        args.outputs.labels << { x: 640, y: 380, text: "SCORE: #{args.state.final_score}", size_enum: 3, alignment_enum: 1, r: 250, g: 250, b: 250 }
