...
$display_room_debug = false
$display_los_debug = false
$display_npc_debug = true
...
require 'app/lib/gui'
require 'app/lib/gui/inventory'
require 'app/lib/gui/cursor'
...
require 'app/lib/item/ring'
require 'app/lib/item/weapon'
require 'app/lib/combat'
require 'app/lib/species'
require 'app/lib/trauma'
require 'app/lib/run'
require 'app/lib/behaviour'
require 'app/lib/item/potion'
require 'app/lib/item/food'
require 'app/lib/item/scroll'
...
require 'app/lib/item/valuable'
require 'app/lib/item/wand'
...
def gameplay_tick args
  ...
  GUI.draw_room_debug args if $display_room_debug
  GUI.draw_corridor_debug args if $display_room_debug
  GUI.draw_los_debug args if $display_los_debug
  GUI.draw_npc_debug args if $display_npc_debug
  HUD.draw args
